...
export default function BuildsheetEditorBlog() {
    return (
        <div>
            <h1>Designing the Buildsheet Editor</h1>
            ...
            <p>As the only one on the team that had programming experience, I was the sole developer and maintainer of the application, managing both the application-to-package database and source code, integrating technician suggestions and feedback into the application.</p>
            </p>
        </div>
    )
}
